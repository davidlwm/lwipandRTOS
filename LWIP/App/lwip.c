...
/* USER CODE BEGIN IP_ADDRESSES */
  ...
  printf("[lwIP] Calling tcpip_init()...\r\n");
/* USER CODE END IP_ADDRESSES */

  /* Initilialize the LwIP stack with RTOS */
  tcpip_init( NULL, NULL );

  printf("[lwIP] tcpip_init() completed\r\n");
  ...
  printf("[lwIP] IP addresses configured\r\n");

  /* add the network interface (IPv4/IPv6) with RTOS */
  printf("[lwIP] Adding network interface...\r\n");
  netif_add(&gnetif, &ipaddr, &netmask, &gw, NULL, &ethernetif_init, &tcpip_input);

  printf("[lwIP] Network interface added\r\n");
...
/* USER CODE BEGIN H7_OS_THREAD_NEW_CMSIS_RTOS_V2 */
  printf("[lwIP] Creating Ethernet link thread...\r\n");
